...
<p>The field under validation must have a size between the given <em>min</em> and <em>max</em>. Strings, numerics, and
    files are evaluated in the same fashion as the <a href="https://laravel.com/docs/5.4/validation#rule-size"
                                                      target="_blank"><code class=" language-php">size</code></a> rule.
</p>
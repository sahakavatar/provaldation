...
<p>The field under validation must be a value preceding or equal to the given date. The dates will be passed into the
    PHP <code class=" language-php">strtotime</code> function.</p>
...
<h4>after:date</h4>
<p>The field under validation must be a value after a given date. The dates will be passed into the <code
            class=" language-php">strtotime</code> PHP function:</p>
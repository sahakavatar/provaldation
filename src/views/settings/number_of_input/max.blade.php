<div class="form-group m-b-10 clearfix">
    <label class="col-md-4 control-label label-bold text-center" for="textinput">Select max Charts Count</label>
    <div class="col-md-8">
        <input name="textinput" type="number" min="1" data-rule="max" class="form-control input-md">
    </div>
</div>
